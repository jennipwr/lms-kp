...
<div class="dk-wrapper">
    ...
    <div class="dk-breadcrumb">
        <a href="{{ route('mahasiswa.lihat-kelas') }}" class="dk-breadcrumb-link">
    ...
    <div class="dk-hero">
        ...
        <div class="dk-hero-content">
            ...
            <div class="dk-hero-meta">
                ...
                <span><i class="bi bi-person-badge-fill"></i> {{ $kelas->dosen->user->nama ?? 'Dosen tidak tersedia' }}</span>
                <span class="dk-hero-sep">•</span>
    ...
    <div id="tab-konten" class="dk-panel dk-panel-active">
        <div class="dk-empty-konten">
            ...
            <p>Dosen belum menambahkan konten untuk kelas ini. Pantau terus ya!</p>
        </div>
    </div>
    ...
    <div id="tab-anggota" class="dk-panel">
        ...
        <div class="dk-member-list">
            <div class="dk-member-card dk-member-dosen">
                ...
                <div class="dk-member-info">
                    <span class="dk-member-name">{{ $kelas->dosen->user->nama ?? 'Dosen tidak tersedia' }}</span>
                    <span class="dk-member-role">Dosen Pengampu</span>
                </div>
        ...
        @if($kelas->kelasMahasiswa->isEmpty())
            <div class="dk-empty-member">
                ...
                <span>Belum ada mahasiswa yang bergabung.</span>
            </div>
        @else
            <div class="dk-member-list">
                @foreach($kelas->kelasMahasiswa as $km)
                    <div class="dk-member-card {{ $km->mahasiswa_nrp === $mahasiswa->nrp ? 'dk-member-self' : '' }}">
...
<style>
    ...
    .dk-empty-icon {
        font-size: 3.5rem; color: var(--border); margin-bottom: .85rem;
    }
...
<script>
    function switchTab(tabName, el) {
        ...
        // Tampilkan panel & aktifkan tab yang dipilih
